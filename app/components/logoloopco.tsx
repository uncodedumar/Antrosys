    ...
    >
      <div className="block transition-all duration-300">
        <div className="flex flex-col items-center space-y-2">
          ...
          <span className="text-sm font-medium text-accent group-hover:text-white transition-colors duration-300 opacity-0 group-hover:opacity-100">
            {logo.name}
          </span>
        </div>
      </div>
...
export default function LogoLoopSection() {
  ...
  return (
    <section className="py-5 md:py-5 bg-primary overflow-hidden">
