...
export const testimonialCards: CardData[] = [
  { rotation: '-6', bgColor: '#F5F2E9', textColor: 'text-zinc-900', starColor: '#FF6B2C', name: "Anas Shahid", role: "Managing Director", company: "Bricklix", review: "Their attention to detail in the UI phase was unlike anything we've seen. Truly a top-tier partner.", src: "/People/a.avif" },
  { rotation: '-3', bgColor: '#EF571B', textColor: 'text-zinc-100', starColor: '#FF6B2C', name: "Alex Chen", role: "Founder", company: "Vantagy", review: "The scaling issues we had were solved in weeks. If you want results, this is the team.", src: "https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?w=100&h=100&fit=crop&crop=faces&auto=format&q=80" },
